...
//com espaço, separa as palvras pelo espaço
...
// TRIM
// trim remove espaços no e final de uma string
...
//console.log(nome.toLowerCase()); //késsia
//console.log(cargo.toUpperCase()); //INSTRUTORA

// FOREACH
//let nomes = ["João", "Guilerme", "Maria"];
...
// POP -> Remove elemento no final da lista
//lista.pop();
//console.log(lista)
...
//let parte = numeros.slice(1, 3) // 1 e 3 são as posições do array (começa no 0)
//console.log(parte)
...
/*
    ...
    item1, ..., itemX -> itens a serem adiicionados
